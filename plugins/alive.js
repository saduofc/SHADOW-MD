...
const ALIVE_IMG = "https://files.catbox.moe/eigd9d.jpg"; // Assurez-vous que cette URL est valide
...
🤖 *Status*: *SHADOW-MD is Alive and Ready!*
...
🎉 *Enjoy the Service!*
        ...
        await conn.sendMessage(from, {
            audio: { url: 'https://github.com/Nethuni2007/SHADOW-VOICE/raw/refs/heads/main/database/bab21e74-a225-4003-8485-5f65abce3dd5.mp3' },
            mimetype: 'audio/mp4',
            ptt: true,
            contextInfo: { 
                mentionedJid: [m.sender],
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: 'SHADOW MD 𝗔𝗟𝗜𝗩𝗘',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
